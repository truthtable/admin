...
import { URL as API_URL } from "../../services/Api.jsx";
...
import { axiosInstance as axios } from "../../services/Api.jsx";
export const GasEditUi = ({
     ...
     //console.log(deliveryGasList);
     //console.log(mtGasList);
     ...
     const handleSubmit = async () => {
          ...
          if (isAddNewDeliveryModal) {
               ...
               //console.log("tempNewGasDataNoIds : ", tempNewGasDataNoIds);
               ...
               if (updateGasData.length > 0) {
                    ...
                    //console.log("updateGasData : ", updateGasData);
                         ...
                         </Stack>
                         {
                              !isOutstanding ? (<>
                                   ...
                                   >
                                        ...
                                        <ListItem>
                                             <ListItemContent>
                                                  <Input value={editName} onChange={(event) => handleGasSearchChange(event.target.value)} placeholder="Add Gas" />
                                             </ListItemContent>
                                        </ListItem>
                                   </List>

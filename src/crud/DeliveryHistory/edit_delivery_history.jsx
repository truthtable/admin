...
function edit_delivery_history() {
                    ...
                    <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/3 sm:p-0 md:p-2 lg:p-4">
                         <div className="form-group">
                              ...
                              <input
                                   ...
                                   onChange={(e) =>
                                        setCourier_Boy_Name(e.target.value)
                                   }
                    ...
                    <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/3 sm:p-0 md:p-2 lg:p-4">
                         <div className="form-group">
                              ...
                              <input
                                   ...
                                   onChange={(e) =>
                                        setGas_Cylinder_Company(e.target.value)
                                   }
                                   className="w-full px-3 py-2 border rounded-md"
                              />
                         </div>
                    ...
                    <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/3 sm:p-0 md:p-2 lg:p-4">
                         <div className="form-group">
                              ...
                              <input
                                   ...
                                   onChange={(e) =>
                                        setRecived_Amount(e.target.value)
                                   }
                                   className="w-full px-3 py-2 border rounded-md"
                              />
                         </div>
...
export default edit_delivery_history;
